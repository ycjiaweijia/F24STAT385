...
(b) **\[1pts\]** Check if `vec1` is a vector? A factor? In addition, use `class()` function to check the type of `vec1`.
...
(c) **\[1pts\]** Check if `vec1_factor` is a vector? A factor? In addition, use `class()` function to check the type of `vec1_factor`.
